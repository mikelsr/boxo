...
func (i *handler) serveRawBlock(ctx context.Context, w http.ResponseWriter, r *http.Request, imPath path.ImmutablePath, contentPath path.Path, begin time.Time) bool {
