...
func (i *handler) serveCodec(ctx context.Context, w http.ResponseWriter, r *http.Request, imPath path.ImmutablePath, contentPath path.Path, begin time.Time, requestedContentType string) bool {
...
func (i *handler) renderCodec(ctx context.Context, w http.ResponseWriter, r *http.Request, resolvedPath path.ResolvedPath, blockData io.ReadSeekCloser, contentPath path.Path, begin time.Time, requestedContentType string) bool {
