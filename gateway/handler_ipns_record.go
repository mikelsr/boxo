...
func (i *handler) serveIpnsRecord(ctx context.Context, w http.ResponseWriter, r *http.Request, contentPath path.Path, begin time.Time, logger *zap.SugaredLogger) bool {
