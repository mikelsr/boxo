...
func (api *errorMockAPI) Get(ctx context.Context, path path.ImmutablePath, getRange ...ByteRange) (ContentPathMetadata, *GetResponse, error) {
	return ContentPathMetadata{}, nil, api.err
}

func (api *errorMockAPI) GetAll(ctx context.Context, path path.ImmutablePath) (ContentPathMetadata, files.Node, error) {
	return ContentPathMetadata{}, nil, api.err
}

func (api *errorMockAPI) GetBlock(ctx context.Context, path path.ImmutablePath) (ContentPathMetadata, files.File, error) {
	return ContentPathMetadata{}, nil, api.err
}

func (api *errorMockAPI) Head(ctx context.Context, p path.ImmutablePath) (ContentPathMetadata, files.Node, error) {
	return ContentPathMetadata{}, nil, api.err
}

func (api *errorMockAPI) GetCAR(ctx context.Context, p path.ImmutablePath) (ContentPathMetadata, io.ReadCloser, <-chan error, error) {
	return ContentPathMetadata{}, nil, nil, api.err
}

func (api *errorMockAPI) ResolveMutable(ctx context.Context, p path.Path) (path.ImmutablePath, error) {
	return path.ImmutablePath{}, api.err
}
...
func (api *errorMockAPI) GetDNSLinkRecord(ctx context.Context, hostname string) (path.Path, error) {
	return nil, api.err
}

func (api *errorMockAPI) IsCached(ctx context.Context, p path.Path) bool {
	return false
}

func (api *errorMockAPI) ResolvePath(ctx context.Context, path path.ImmutablePath) (ContentPathMetadata, error) {
...
func (api *panicMockAPI) Get(ctx context.Context, immutablePath path.ImmutablePath, ranges ...ByteRange) (ContentPathMetadata, *GetResponse, error) {
	panic("i am panicking")
}

func (api *panicMockAPI) GetAll(ctx context.Context, immutablePath path.ImmutablePath) (ContentPathMetadata, files.Node, error) {
	panic("i am panicking")
}

func (api *panicMockAPI) GetBlock(ctx context.Context, immutablePath path.ImmutablePath) (ContentPathMetadata, files.File, error) {
	panic("i am panicking")
}

func (api *panicMockAPI) Head(ctx context.Context, immutablePath path.ImmutablePath) (ContentPathMetadata, files.Node, error) {
	panic("i am panicking")
}

func (api *panicMockAPI) GetCAR(ctx context.Context, immutablePath path.ImmutablePath) (ContentPathMetadata, io.ReadCloser, <-chan error, error) {
	panic("i am panicking")
}

func (api *panicMockAPI) ResolveMutable(ctx context.Context, p path.Path) (path.ImmutablePath, error) {
	panic("i am panicking")
}
...
func (api *panicMockAPI) GetDNSLinkRecord(ctx context.Context, hostname string) (path.Path, error) {
...
func (api *panicMockAPI) IsCached(ctx context.Context, p path.Path) bool {
	panic("i am panicking")
}

func (api *panicMockAPI) ResolvePath(ctx context.Context, immutablePath path.ImmutablePath) (ContentPathMetadata, error) {
	panic("i am panicking")
}
