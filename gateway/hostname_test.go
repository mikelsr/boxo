...
func TestToSubdomainURL(t *testing.T) {
	...
	gwAPI.namesys["/ipns/dnslink.long-name.example.com"] = path.NewIPFSPath(testCID)
	gwAPI.namesys["/ipns/dnslink.too-long.f1siqrebi3vir8sab33hu5vcy008djegvay6atmz91ojesyjs8lx350b7y7i1nvyw2haytfukfyu2f2x4tocdrfa0zgij6p4zpl4u5o.example.com"] = path.NewIPFSPath(testCID)
